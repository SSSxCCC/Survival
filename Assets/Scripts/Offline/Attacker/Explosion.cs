...
namespace Offline
{
    public class Explosion : MonoBehaviour, IExplosion
    {
        ...
        private void Awake() { commonExplosion = new CommonExplosion<Explosion>(this); }

        // 对碰到爆炸的单位造成伤害
        private void OnTriggerEnter2D(Collider2D collision) { commonExplosion.OnTriggerEnter2D(collision); }
    }
}