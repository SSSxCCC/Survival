    ...
    public class GameManager : NetworkBehaviour
    {
        ...
        private IEnumerator SpawnEnemies()
        {
            ...
            for (; numSpawnedEnemy < level * 10; numSpawnedEnemy++)
            {
                ...
                if (level <= 1) enemy.GetComponent<IState>().maxHealth = 1; // 降低等级一的难度
        ...
        public void OnKilledEnemy()
        {
            ...
            {
                if (enemy.GetComponent<IState>().health > 0) numLiveEnemys++;
            }
        ...
        public void OnKilledPlayer()
        {
            ...
            foreach (GameObject player in players)
            {
                if (player.GetComponent<IState>().health > 0) numLivePlayers++;
            }
