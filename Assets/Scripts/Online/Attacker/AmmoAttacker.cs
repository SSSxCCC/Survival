...
namespace Online
{
    public abstract class AmmoAttacker : NetworkBehaviour, IAmmoAttacker
    {
        ...
        {
            commonAmmoAttacker = new CommonAmmoAttacker<AmmoAttacker>(this);
        }

        // 弹药初始化
        protected virtual void Start()
        {
            commonAmmoAttacker.Start();
        }
        ...
        {
            commonAmmoAttacker.OnCollisionEnter2D(collision);
        }
