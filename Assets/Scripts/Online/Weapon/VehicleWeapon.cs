...
namespace Online
{
    public class VehicleWeapon : NetworkBehaviour, IVehicleWeapon
    {
        ...
        {
            return commonVehicleWeapon.Fire(owner);
        }
        ...
        {
            NetworkServer.Spawn(commonVehicleWeapon.CreateAmmo(owner));
        }
    }
}