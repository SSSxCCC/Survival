...
public class Car : Vehicle {
    ...
    private void Update() {
        ...
        if (passenger3 != null) passenger3.transform.position = seats[GetSeat(passenger3)].position;
    }
    ...
    public override void LeaveAll() {
        ...
        if (passenger3 != null) Leave(passenger3);
    }
    ...
    private int GetSeat(GameObject player) {
        ...
        else if (player == passenger3) return 3;
        else return -1;
    }
}
